...
def plot_network_logs(DIR, type="fl", number_of_clients=5, offset=0):
    ...
    for i in range(number_of_clients):
        ...
        client_data["tx_rate_bps"] = client_data["tx_rate_bps"][:500] // (1024*1024)
        client_data["rx_rate_bps"] = client_data["rx_rate_bps"][:500] // (1024*1024)
    ...
    if type == "flclient":
        ...
        server["tx_rate_bps"] = server["tx_rate_bps"][:500] // (1024 * 1024)
        server["rx_rate_bps"] = server["rx_rate_bps"][:500] // (1024 * 1024)
...
plot_network_logs("50rounds_gabriel50_v0/fwd3_r100_g50_v0_0323_000153", type="flclient", number_of_clients=5, offset=5)